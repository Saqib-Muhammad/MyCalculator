...
//        val viewModel = ViewModelProviders.of(this).get(CalculatorViewModel::class.java)
        ...
        // create or call the static of() of the viewModelProviders class to get a ViewModelProvider and then you call its get() to get the ViewModel type you want.

        //  the code to start observing the ViewModel's LiveData objects is simple.
